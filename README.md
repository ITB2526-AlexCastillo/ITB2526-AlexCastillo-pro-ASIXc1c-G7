PROYECTO TRANSVERSAL ASIXc 2025_2026
...
* Propuesta CDP
* Ubicación física
* Situación física de la sala y el edificio
...
* Suelo técnico y semicierre de techo técnico
...
* Infraestructura IT (Equipamiento activo de los racks)
...
* Inventario y modelo de distribución en unidad de rack
...
* Justificación de Arquitectura de Conmutación (Spanning tree)
...
* Seguridad física
*  Elementos de control de acceso a incorporar en el CPD y Videovigilància
...
* Seguridad lógica
* Restricción d’accés per autorització
...
* Intentos de acceso SSH o SFTP fallidos para alertar de posibles ataques de fuerza bruta.
* Uso de CPU, memoria RAM y almacenamiento en disco de cada servidor.
* Altas, bajas o modificaciones de privilegios en el árbol del Directorio Activo.
* Còpies de seguretat/Backups y RAIDs
...
* Implementación del CPD al Núvol AWS y servicios utilizados
Creamos la VPC
...
Crear el usuario sin contraseña para obligar a usar llaves SSH

Meter al usuario en el grupo de administradores (sudo)

```bash
Configurar sudo para que no le pida contraseña de texto nunca
```
...
* Implantación de servicios de audio y vídeo
